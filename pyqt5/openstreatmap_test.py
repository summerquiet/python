...
>>>>>>> a19e68f6aa601e21b6839c77bdf4bffba1b8cc07
        #最后一块瓷砖水平和垂直结束位置
    ...
    def download(self):
        ...
        #Tile map URL
        #OpenStreatMap
        #url_string = 'http://c.tile.openstreetmap.org/%d/%d/%d.png'
        #opencyclemap
        url_string = 'http://b.tile2.opencyclemap.org/transport/%d/%d/%d.png'
        #url_string = 'http://c.tile.opencyclemap.org/cycle/%d/%d/%d.png'

        path = url_string % (self.zoom, grab.x(), grab.y())
